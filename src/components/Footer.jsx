        ...
        <div className="grid gap-16 lg:grid-cols-[1fr_0.6fr]">
          ...
          <div className="grid grid-cols-2 gap-10 md:grid-cols-3">
            <nav className="flex flex-col gap-5" aria-label="Навигация в футере">
              ...
              <Link to="/catalog" className="text-lg uppercase hover:text-[#d58b2a] hover:underline underline-offset-4">Каталог</Link>
              <Link to="/cart" className="text-lg uppercase hover:text-[#d58b2a] hover:underline underline-offset-4">Корзина</Link>
            </nav>
            <nav className="flex flex-col gap-5" aria-label="Аккаунт в футере">
              ...
              <Link to="/profile" className="text-lg uppercase hover:text-[#d58b2a] hover:underline underline-offset-4">Профиль</Link>
              <Link to="/login" className="text-lg uppercase hover:text-[#d58b2a] hover:underline underline-offset-4">Войти</Link>
            </nav>
          </div>
        </div>

        <div className="mt-20 border-t border-[#fff8c9]/20 pt-10 text-sm uppercase tracking-[0.2em] text-[#fff8c9]/50 flex flex-col md:flex-row justify-between gap-6">
